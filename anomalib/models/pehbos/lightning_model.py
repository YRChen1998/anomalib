"""PEHBOS: a Patch Embedding HBOS Framework for Anomaly Detection and Localization.
...
from anomalib.models.pehbos.torch_model import PehbosModel
...
class Pehbos(AnomalyModule):
    ...
    def __init__(
        ...
        self.layers = layers
        self.model: PehbosModel = PehbosModel(
    ...
    def configure_optimizers() -> None:  # pylint: disable=arguments-differ
        """PEHBOS doesn't require optimization, therefore returns no optimizers."""
        return None

    def training_step(self, batch: dict[str, str | Tensor], *args, **kwargs) -> None:
        """Training Step of PEHBOS. For each batch, hierarchical features are extracted from the CNN.
    ...
    def on_validation_start(self) -> None:
        """Fit a HBOS to the embedding collected from the training set."""
...
class PehbosLightning(Pehbos):
    """PEHBOS: a Patch Embedding HBOS for Anomaly Detection and Localization.
